...
const InputOTPSlot = React.forwardRef(({ index, className, ...props }, ref) => {
  ...
  return (
    (<div
      ref={ref}
      className={cn(
        "relative flex w-14 h-14 items-center justify-center border-y border-r border-neutral-200 text-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md dark:border-neutral-800",
