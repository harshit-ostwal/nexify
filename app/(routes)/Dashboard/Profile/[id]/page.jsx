...
import Img from "@/public/Anshika.jpeg"
        ...
        <div className="flex flex-col items-center w-full min-h-screen gap-20">
                ...
                <div className="flex flex-col items-center justify-between w-full md:flex-row lg:w-2/3">
                    <div className="flex gap-10">
                        <div className="relative w-40 h-40">
                            <Image src={Img} alt="User" fill className="object-cover border-8 border-white rounded-full" quality={100} fetchPriority="high" priority />
                        </div>
                        <div className="flex flex-col gap-4">
                            <h1 className="text-4xl font-bold text-white">{session?.user?.fullname}</h1>
                            <div className="flex gap-2">
                                <span className="px-2 py-1 border rounded-md text-amber-500 border-amber-500">Ui Designer</span>
                                <span className="px-2 py-1 border rounded-md text-amber-500 border-amber-500">Backend Developer</span>
                                <span className="px-2 py-1 border rounded-md text-amber-500 border-amber-500">Frontend Developer</span>
                            </div>
                            <p className="max-w-md text-sm text-white">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Debitis sapiente rerum beatae dolorum minus suscipit soluta.</p>
                        </div>
                    </div>
            ...
            <div className="flex flex-col items-end w-11/12 gap-10 p-10 rounded-md lg:w-2/3 bg-neutral-50">
                ...
                <div className="flex flex-col items-end gap-4">
                    <p className={`${!seeMore && "line-clamp-4 text-ellipsis"} `}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magni aspernatur error autem incidunt sit enim veritatis? Magni necessitatibus sed nisi eos quia iusto enim earum, quo animi fugit autem labore perspiciatis itaque provident, ipsum obcaecati libero dignissimos minima iure consequuntur. Officia quaerat repudiandae delectus facilis. Nam voluptas natus sint, odit illum quo pariatur facilis, et architecto harum maxime maiores! Eligendi qui fuga repellendus, atque consectetur dolore iure nobis voluptate vitae distinctio deleniti enim quo eum dolorem repudiandae est tempore nihil asperiores perspiciatis minus, maxime quae modi fugit esse! Amet vitae dolorem expedita! Laboriosam obcaecati cumque distinctio eveniet, temporibus vitae illo! Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cumque non rerum necessitatibus quod commodi delectus, blanditiis quasi molestiae dolores deleniti vitae mollitia. Unde ex minima qui blanditiis consequuntur, asperiores incidunt dolore aliquid temporibus deleniti praesentium saepe nam repellendus consectetur esse illum quas cumque! Delectus architecto, culpa asperiores, velit quam similique corporis expedita non tempora omnis doloribus nisi quis quaerat eaque molestiae consectetur inventore quod quia quidem nemo reiciendis magni voluptate. Sequi libero beatae recusandae rerum, saepe pariatur exercitationem, natus alias, quasi doloribus vitae? Modi perferendis tenetur nemo porro vel tempora, fugit dignissimos aliquid corporis et numquam ut, omnis illum! Reiciendis suscipit deserunt fuga quae consectetur numquam dolore, earum aspernatur sequi veniam autem dolores doloremque inventore eum in provident rem obcaecati quibusdam perspiciatis laudantium dolorum voluptas deleniti illum. Nihil nesciunt odit beatae doloremque quia deserunt quis, similique quasi itaque laudantium aliquam nam voluptatum eligendi dolor eaque sapiente in provident! Cupiditate, tenetur nisi doloremque a aspernatur assumenda vero eum quod explicabo voluptates nostrum repellat facilis laborum consectetur consequuntur ipsa aperiam eos officiis? Iusto, voluptatem! Vitae, tempora vel? Placeat eveniet consequuntur est maiores? Tempora maiores natus corporis, cumque voluptates facere officiis modi illo harum, quisquam dolor culpa voluptas architecto! Id esse cumque eaque.</p>
